...
function laptop(x){
	...
	if ( x == 0){
		...
		loan = loan + 60000;
		$("#loid")[0].children[0].innerHTML = "+" + 60000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
		...
		// Loan =================
		calculateLoanAndApplyChange(loan+25000);
		loan = loan + 25000;
		$("#loid")[0].children[0].innerHTML = "+" + 25000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
...
function creditcard(x , debt){
	...
	if ( x == 0){
		...
		// Money code
		calculateLoanAndApplyChange(debt + 10000);
		loan = debt + 10000;
		$("#loid")[0].children[0].innerHTML = "+" + 10000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
		...
		// Loan =================
		calculateLoanAndApplyChange(debt+2000);
		loan = debt+2000
		$("#loid")[0].children[0].innerHTML = "+" + 2000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
...
function chill(x){
	...
	if ( x == 0){
		...
		// Money code
		calculateLoanAndApplyChange(loan + 200);
		loan = loan + 200;
		$("#loid")[0].children[0].innerHTML = "+" + 200; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
		...
		// Loan =================
		calculateLoanAndApplyChange(loan+3500);
		loan = loan+3500
		$("#loid")[0].children[0].innerHTML = "+" + 3500; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
		...
		// Loan =======================
		calculateLoanAndApplyChange(loan + 12000);
		loan = loan + 12000;
		$("#loid")[0].children[0].innerHTML = "+" + 12000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
...
function jobloss(x , debt){
	...
	if ( x == 0){
		...
		// Money code
		calculateLoanAndApplyChange(debt + 20000);
		loan = debt + 20000;
		$("#loid")[0].children[0].innerHTML = "+" + 20000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
		...
		// Loan =================
		calculateLoanAndApplyChange(debt + 15000);
		loan = debt + 15000
		$("#loid")[0].children[0].innerHTML = "+" + 15000; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
		...
		// Loan =======================
		calculateLoanAndApplyChange(debt + 9500);
		loan = debt + 9500;
		$("#loid")[0].children[0].innerHTML = "+" + 9500; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
...
function dress(x){
	...
	if ( x == 0){
		...
		// Loan =======================
		calculateLoanAndApplyChange(loan + 8500);
		loan = loan + 8500;
		$("#loid")[0].children[0].innerHTML = "+" + 8500; 
		$("#loid").css({"opacity" : "1"})
		setTimeout(function () {
			$("#loid").css({"opacity" : "0"});
		}, 2000);
