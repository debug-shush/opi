# Generated by Django 2.2.16 on 2020-10-23 07:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kenken_solver', jsonfield.fields.JSONField()),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Crosswordplayer',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submittedCrossword', jsonfield.fields.JSONField(default='')),
                ('puzzle_score', models.CharField(blank=True, max_length=10, null=True)),
                ('age_sum', models.BooleanField(blank=True, max_length=10, null=True)),
                ('letter_sum', models.BooleanField(blank=True, max_length=10, null=True)),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
